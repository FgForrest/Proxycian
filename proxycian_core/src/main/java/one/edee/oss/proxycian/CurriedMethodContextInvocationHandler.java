...
public interface CurriedMethodContextInvocationHandler<PROXY, PROXY_STATE> {
	 ...
	 * @throws Throwable propagated exception if thrown in invocation
	 */
	Object invoke(PROXY proxy, Method method, Object[] args, PROXY_STATE proxyState, Callable<Object> invokeSuper) throws Throwable;
