...
/**
 * ClassLoadingStrategy is va MethodHandles::lookup with fallback as JVM is running on JDK11, this is a behaviour called via MultiReleaseBuild. Other strategies are evaluated when running JDK8 / JDK17 with MultiRelease Build
 *
