 ...
 *
 * Our proxies are generated inside the package of {@link one.edee.oss.proxycian.bytebuddy.generated}, so for that we have created an dummy class.
 *
 * @author Milos Samek, FG Forrest a.s. (c) 2021
 */
public class GeneratedDummyClass {
}
